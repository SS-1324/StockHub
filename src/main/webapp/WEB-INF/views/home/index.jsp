...
<div class="home-main">
    ...
    <%-- 최신 커뮤니티 게시글을 이미지 높이에 맞춰 2열로 자동 배치 --%>
            ...
            <c:when test="${not empty latestBoards}">
                <div class="home-community-grid">
                    <c:forEach var="board" items="${latestBoards}">
                        ...
                        <a class="home-community-card ${hasBoardTitle ? '' : 'has-no-title'}"
...
<script src="${pageContext.request.contextPath}/js/stockhub.js"></script>
