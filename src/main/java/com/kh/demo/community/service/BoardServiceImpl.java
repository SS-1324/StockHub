...
public class BoardServiceImpl implements BoardService {
    ...
    // 카테고리 허용 목록 (F-COM-01-01) - 팀에서 확정되면 교체
    private static final List<String> ALLOWED_CATEGORIES = List.of("자유게시판", "살까팔까", "수익인증", "질문");
    private static final Set<String> ALLOWED_CATEGORY_SET = Set.copyOf(ALLOWED_CATEGORIES);
    private static final String DEFAULT_CATEGORY = "자유게시판";
    ...
    private String resolveCategory(String category) {
        ...
        if (!ALLOWED_CATEGORY_SET.contains(category)) {
